    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="mx-auto max-w-7xl px-5 pt-12 sm:px-8 sm:pt-16">
        ...
        <p className="mt-4 text-slate-400">
          Browse all opening courses available in our store.
        </p>
      </div>
...
/>
      ...
      <div className="mx-auto my-20 max-w-4xl rounded-2xl border border-slate-800 bg-slate-900 p-6 text-center sm:p-8">
        ...
        <p className="mt-4 text-slate-400">
          Contact us directly on Telegram to purchase any available course.
        </p>
        ...
        <a
          ...
          className="mt-8 inline-block rounded-xl bg-sky-500 px-8 py-4 font-bold text-white transition hover:bg-sky-400"
        >
          Contact on Telegram
        </a>
